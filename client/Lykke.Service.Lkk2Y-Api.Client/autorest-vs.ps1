...
autorest -Input http://localhost:5000/swagger/v1/swagger.json -CodeGenerator CSharp -OutputDirectory ./client/Lykke.Service.Lkk2Y_Api.Client/AutorestClient -Namespace Lykke.Service.Lkk2Y_Api.Client.AutorestClient